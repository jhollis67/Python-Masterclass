...
# with the keys being the number of the locations and the values being
# dictionaries holding the exits (as they do at present). No change
...
while True:
    ...
    direction = input("Available exits are " + availableExits + ". Which direction? ").upper()
    print()
